...
func main() {
	...
	//day4.Run(util.Readlines("day4/input"))
	...
	//day10.Run(util.Readlines("day10/input"))
	//day11.Run(util.Readlines("day11/input"))
	//day12.Run(util.Readlines("day12/input"))
	//day13.Run()
	day14.Run(util.Readlines("day14/input"))
}
